#include <ros/ros.h>
#include <kitti_ros/segmenters_lib/don_segmenter.hpp>
...
void DoNSegmenter::segment(const PointCloudPtr pc,
    ...
    *cloud = *pc;
    ...
    for (; iter != clusters_indices.end(); ++iter) {
        ...
        pcl::copyPointCloud<PointN, Point>(*don_cloud_filtered, *iter,
                                           *cluster);
